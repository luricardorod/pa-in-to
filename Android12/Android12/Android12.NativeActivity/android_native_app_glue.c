...
/* Para compilaciones de depuración, habilite siempre el seguimiento de la depuración en esta biblioteca */
#ifndef NDEBUG
...
static void android_app_destroy(struct android_app* android_app) {
    ...
    pthread_cond_broadcast(&android_app->cond);
    pthread_mutex_unlock(&android_app->mutex);
    // No se puede tocar el objeto android_app después de esto.
}
...
// --------------------------------------------------------------------
// Interacción de actividad nativa (llamada desde el subproceso principal)
// --------------------------------------------------------------------
...
static struct android_app* android_app_create(ANativeActivity* activity,
    ...
    // Espere a que el subproceso empiece.
    pthread_mutex_lock(&android_app->mutex);
